...
25   415. Add Strings    https://leetcode.com/problems/add-strings/
class Solution {
public:

    void sumRE( string &num1, int p1,string &num2, int p2, int carry , string &ans){
            // base condition 
    if(p1<0&&p2<0){
        if(carry!=0){
            ans.push_back(carry+'0');
    ...
    sumRE(num1, p1-1, num2, p2-1, carry, ans);
    }
    string addStrings(string num1, string num2) {
        int p1= num1.size()-1;int p2 = num2.size()-1;
        int carry =0;
        string ans = "";
         sumRE(num1, p1, num2, p2, carry, ans);
         reverse(ans.begin(), ans.end());
        return ans;
            }
};
